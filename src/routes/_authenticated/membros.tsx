  ...
  return (
    <>
      <PageHeader
        eyebrow="Bairro"
        title="Membros"
        description={`${list.length} no total. Carrega num membro para ver o perfil completo.`}
        icon={Users}
        action={
          <Input
          ...
          <tbody>
            ...
            {sorted.map((m) => (
              ...
              >
                ...
                <td className="px-3 py-2 text-muted-foreground">
                  {ROLE_LABELS[m.role_label ?? "bairrista"] ?? m.role_label}
                </td>
                <td className="px-3 py-2">
                  <TierBadge tier={m.tier} />
                </td>
                <td className="px-3 py-2">
                  <AffiliationBadge tier={m.tier} />
                </td>
