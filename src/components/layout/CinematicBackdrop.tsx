  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, oklch(0.10 0.012 25 / 0.55) 0%, oklch(0.10 0.012 25 / 0.78) 60%, oklch(0.08 0.010 25 / 0.92) 100%)",
        }}
      />
      {/* Animated red glows */}
      <div className="absolute -top-24 -left-24 h-[520px] w-[520px] rounded-full bg-primary/25 blur-[140px] animate-float-slow" />
      <div
        className="absolute -bottom-32 -right-24 h-[560px] w-[560px] rounded-full bg-blood/25 blur-[140px] animate-float-slow"
